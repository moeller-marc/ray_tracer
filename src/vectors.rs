pub mod vectors {
    ...
    mod tests {
        ...
        fn test_point3_new() {
            ...
            assert_eq!(p, Point3 { x: 1.0, y: 2.0, z: 3.0 });
        }

        #[test]
        fn test_color_new() {
            let c = Color::new(0.1, 0.2, 0.3);
            assert_eq!(c, Color { r: 0.1, g: 0.2, b: 0.3 });
        }
        ...
        fn test_point3_add() {
            ...
            p1.add(p2);
            assert_eq!(p1, Point3 { x: 5.0, y: 7.0, z: 9.0 });
        }
        ...
        fn test_color_add() {
            ...
            c1.b.round();
            c1.b = c1.b / 100.0;
            assert_eq!(c1, Color { r: 0.5, g: 0.7, b: 0.9 });
        }
        ...
        fn test_point3_multiply_by_number() {
            ...
            assert_eq!(p, Point3 { x: 2.0, y: 4.0, z: 6.0 });
        }
        ...
        fn test_color_multiply_by_number() {
            ...
            assert_eq!(c, Color { r: 0.2, g: 0.4, b: 0.6 });
        }
